#pragma checksum "E:\HireHub\Views\Chat\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8cb507daca2ee2ccecd6fcd7edf3613e5bbb5dda"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8cb507daca2ee2ccecd6fcd7edf3613e5bbb5dda", @"/Views/Chat/Index.cshtml")]
    ...
    public class Views_Chat_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<List<PlacementManagementSystem.Models.ChatMessageViewModel>>
    {
...
<div class=""container-fluid"">
    ...
    <div class=""d-flex justify-content-between align-items-center mb-3"">
        ...
        <div class=""d-flex align-items-center"">
            <button id=""clearOldMessages"" class=""btn btn-sm btn-outline-warning mr-2"" style=""display: none;"">
...
#nullable restore
#line 24 "E:\HireHub\Views\Chat\Index.cshtml"
...
#nullable disable
            WriteLiteral("\r\n                </div>\r\n");
#nullable restore
#line 26 "E:\HireHub\Views\Chat\Index.cshtml"
            }
...
");
#nullable restore
#line 36 "E:\HireHub\Views\Chat\Index.cshtml"
                         if (Model != null)
                        {
...
#nullable disable
#nullable restore
#line 38 "E:\HireHub\Views\Chat\Index.cshtml"
...
#nullable disable
            WriteLiteral("                                <div");
            BeginWriteAttribute("class", " class=\"", 1536, "\"", 1605, 2);
            WriteAttributeValue("", 1544, "message", 1544, 7, true);
#nullable restore
#line 40 "E:\HireHub\Views\Chat\Index.cshtml"
WriteAttributeValue(" ", 1551, msg.IsOwnMessage ? "own-message" : "other-message", 1552, 53, false);
...
#nullable restore
#line 42 "E:\HireHub\Views\Chat\Index.cshtml"
...
#nullable disable
            WriteLiteral("</small>\r\n");
#nullable restore
#line 44 "E:\HireHub\Views\Chat\Index.cshtml"
                                         if (msg.IsOwnMessage)
                                        {
...
#nullable restore
#line 49 "E:\HireHub\Views\Chat\Index.cshtml"
                                        }
...
#nullable restore
#line 51 "E:\HireHub\Views\Chat\Index.cshtml"
                                                            Write(msg.Message);
...
#nullable disable
            WriteLiteral("</div>\r\n                                </div>\r\n");
#nullable restore
#line 53 "E:\HireHub\Views\Chat\Index.cshtml"
                            }
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8cb507daca2ee2ccecd6fcd7edf3613e5bbb5dda9878", async() => {
                WriteLiteral(@"
...
");
    ...
    <script>
        ...
        const currentUserId = '");
#nullable restore
#line 159 "E:\HireHub\Views\Chat\Index.cshtml"
...
#nullable disable
        ...
        // Handle clear old messages button
        document.getElementById('clearOldMessages').addEventListener('click', function() {
            if (confirm('Are you sure you want to clear all your old chat messages? This action cannot be undone.')) {
                fetch('/Chat/ClearOldMessages', {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        // Hide the button
 ");
                WriteLiteral(@"                       this.style.display = 'none';
                    } else {
        ...
        // Check for old messages and show clear button if needed (only if user has chat access)
        function checkForOldMessages() {
            if (mes");
                WriteLiteral(@"sageForm) { // Only check if user has chat access
                fetch('/Chat/DebugChatState')
                    .then(response => response.json())
                    .then(data => {
                        if (data.allMessages && data.allMessages.length > 0) {
                            document.getElementById('clearOldMessages').style.display = 'inline-block';
                        }
                    })
                    .catch(error => {
                        console.error('Error checking for old messages:', error);
                    });
            }
        }

        // Check for old messages on page load
        checkForOldMessages();
...
");
    ...
    ");
                WriteLiteral(@"    document.addEventListener('click', function (e) {
...
");
        ...
        [global::Microsoft.AspNetCore.Mvc.Razor.Internal.RazorInjectAttribute]
        public global::Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper<List<PlacementManagementSystem.Models.ChatMessageViewModel>> Html { get; private set; }
    }
}
